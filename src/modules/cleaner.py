...
# Function to strip all non alphanumeric characters from a string to create a "cleaned"
# verison.
...
# Function that takes in a list of course objects and produces a list of "cleaned" course
# names
# Parameters:
