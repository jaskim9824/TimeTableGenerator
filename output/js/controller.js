...
$scope.TraditionalPlanFallTerm3obj = {2:"2A"};
$scope.TraditionalPlanWinterTerm4obj = {2:"2A"};
$scope.TraditionalPlanFallTerm5obj = {3:"3A"};
$scope.TraditionalPlanWinterTerm6obj = {3:"3A"};
